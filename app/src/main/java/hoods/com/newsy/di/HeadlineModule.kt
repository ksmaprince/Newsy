...
object HeadlineModule {
    ...
    @Provides
    @Singleton
    fun provideHeadlineRemoteMediator(
        api: HeadlineApi,
        db: NewsyArticleDatabase
    ): HeadlineRemoteMediator =
        HeadlineRemoteMediator(api = api, database = db)
    ...
    @Provides
    @Singleton
    fun provideHeadlineMapper(): Mapper<HeadlineDto, NewsyArticle> = HeadlineMapper<HeadlineDto, NewsyArticle>()
