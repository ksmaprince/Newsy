...
class HeadlineApiKtTest {
    ...
    @Test
    fun `getHeadLines should hit correct endpoint`() = runTest {
        //GIVEN
    ...
    fun `getHeadline article handle 404 error`() = runTest {
        //GIVEN
    ...
    fun `getHeadline article handle network failure`() = runTest {
        //GIVEN
        mockWebServer.shutdown()
        //WHEN
        val actualResponse = api.getHeadlines(
